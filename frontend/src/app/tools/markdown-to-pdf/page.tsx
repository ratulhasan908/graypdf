        ...
        >
                ...
                <>
                    ...
                    <div className="card p-5 animate-fade-in">
                        <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-sm">
                                    <FileType className="w-4 h-4 text-white" strokeWidth={2.5} />
                                </div>
                        ...
                        <div className="relative">
                            {/* Line numbers */}
                            <div className="absolute left-0 top-0 bottom-0 w-10 bg-[#FCF1D0]/60 border-r border-[#e5dcb8] rounded-l-xl py-3 text-right pr-2 pointer-events-none overflow-hidden">
                                {markdown.split("\n").map((_, i) => (
                                    <div
                                        key={i}
                            ...
                            <textarea
                                ...
                                rows={16}
                                spellCheck={false}
                                className="w-full pl-12 pr-4 py-3 border border-[#e5dcb8] rounded-xl bg-[#FCF1D0]/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white text-[#010736] font-mono text-sm resize-y leading-5 transition-all"
            ...
            {job && (job.status === "pending" || job.status === "processing") && (
                <div className="card p-12 text-center animate-fade-in relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-500/5 via-transparent to-purple-500/5 animate-pulse-soft" />

                    <div className="relative">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-purple-500 to-purple-600 shadow-xl mb-5">
                            <Loader2 className="w-8 h-8 text-white animate-spin" />
                        </div>

                        <h2 className="text-2xl font-bold text-[#010736] mb-2">
                            {job.status === "pending" ? "Queued..." : "Rendering Markdown"}
                        </h2>
                        ...
                        <div className="max-w-xs mx-auto">
                            <div className="h-1.5 bg-[#FCF1D0] rounded-full overflow-hidden border border-[#e5dcb8]">
                                <div className="h-full w-1/3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full animate-progress" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card p-10 text-center animate-scale-in relative overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <span>Convert more Markdown</span>
                        </button>
                    </div>
                </div>
            )}
