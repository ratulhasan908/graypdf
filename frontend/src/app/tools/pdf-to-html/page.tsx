...
const LAYOUT_OPTIONS: {
    ...
    badge?: string;
}[] = [
        {
            id: "simple",
            title: "Clean HTML",
            desc: "Readable headings and paragraphs. Best for editing.",
            Icon: AlignLeft,
            badge: "Recommended",
        },
        {
            ...
            desc: "Approximate positions preserved. Best for forms.",
            Icon: Layout,
        },
    ];
...
export default function PdfToHtmlPage() {
    ...
    const [layout, setLayout] = useState<Layout2>("simple");
                    ...
                    {file && (
                        <div className="mt-6 animate-fade-in">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full text-left p-4 rounded-2xl border-2 transition-all flex items-start gap-3 ${active
                                                    ...
                                                    : "border-[#e5dcb8] bg-white/70 hover:border-sky-300 hover:bg-white"
                                                }`}
                                        >
                                            <div
                                                className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-all ${active
                                                        ? "bg-gradient-to-br from-sky-500 to-sky-600 shadow-sm"
                                                        : "bg-[#FCF1D0]"
                                                    }`}
                                            >
                                                <Icon
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                                                    ...
                                                    {opt.badge && (
                                                        <span className="text-[10px] font-bold text-sky-700 bg-sky-100 px-2 py-0.5 rounded-full uppercase tracking-wider">
                                                            {opt.badge}
                                                        </span>
                                                    )}
                                                </div>
                            ...
                            <div className="mt-4 px-3 py-2 bg-[#FCF1D0]/60 border border-[#e5dcb8] rounded-xl flex items-start gap-2">
                                ...
                                <p className="text-xs text-[#0D1C42]/60">
                                    Scanned PDFs (image-only) won&apos;t extract text — use OCR
                                    first for those.
                                </p>
                            </div>
                        </div>
