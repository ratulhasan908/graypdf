...
const DPI_LABELS: Record<Dpi, { title: string; desc: string }> = {
    72: {
        title: "Low (72 DPI)",
        desc: "Smallest files, screen use",
    },
    150: {
        title: "Medium (150 DPI) — Recommended",
        desc: "Good balance of quality and size",
    },
    300: {
        title: "High (300 DPI)",
        desc: "Print quality, larger files",
    },
};
    ...
    return (
        <main className="min-h-screen bg-gray-50 px-4 py-12">
            <div className="max-w-2xl mx-auto">
                ...
                <h1 className="text-3xl font-bold mt-4 mb-2">PDF to JPG</h1>
